  ...
  _createClass(Pie, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var labels = sectors.map(function (entry, i) {
        ...
        return _react2.default.createElement(
          ...
          _this2.constructor.renderLabelItem(label, labelProps, (0, _ChartUtils.getValueByDataKey)(entry, realDataKey))
        );
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        (!isAnimationActive || prevSectors && (0, _isEqual3.default)(prevSectors, sectors)) && _LabelList2.default.renderCallByParent(this.props, sectors, false)
      );
    }
  }], [{
    key: 'getTextAnchor',
