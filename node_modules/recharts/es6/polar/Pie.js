...
var Pie = pureRender(_class = (_temp2 = _class2 = function (_Component) {
  ...
  function Pie() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Pie.__proto__ || Object.getPrototypeOf(Pie)).call.apply(_ref, [this].concat(args))), _this), _this.state = { isAnimationFinished: false }, _this.id = uniqueId('recharts-pie-'), _this.cachePrevData = function (sectors) {
  ...
  _createClass(Pie, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var labels = sectors.map(function (entry, i) {
        ...
        return React.createElement(
          Layer,
          { key: 'label-' + i },
          labelLine && _this2.constructor.renderLabelLineItem(labelLine, lineProps),
          _this2.constructor.renderLabelItem(label, labelProps, getValueByDataKey(entry, realDataKey))
        );
      });
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        (!isAnimationActive || prevSectors && _isEqual(prevSectors, sectors)) && LabelList.renderCallByParent(this.props, sectors, false)
      );
    }
  }], [{
    key: 'getTextAnchor',
